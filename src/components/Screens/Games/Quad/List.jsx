...
import { fetchQuadList } from "../../../../actions";
...
class List extends React.Component {
  ...
  componentWillMount = async () => {
    if (this.props.list.length === 0) {
      await this.props.fetchQuadList(
  ...
  onEdit = record => {
    history.push("/games/quad/edit/" + record.id);
  };
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Card title={<div className="card-title">Quad List</div>}>
          <Row>
            <Table
...
const mapStateToProps = state => {
  return {
    list: state.quad.list,
    count: state.quad.count,
    user: state.userAuth
  };
};
