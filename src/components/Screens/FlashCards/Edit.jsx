...
import { addFlashCard, fetchFlashDetails } from "../../../actions";
...
class Edit extends Component {
	...
	async componentDidMount() {
		await this.props.fetchFlashDetails(this.props.user.Authorization, this.props.match.params.id)
...
export default connect(
	mapStateToProps,
	{ addFlashCard, fetchFlashDetails }
)(Form.create()(Edit));
